...
#     assert(x_n!=0)
    ...
    while (x_n != 0 and
        ...
        # check time does not exceed the batch size
        if ((t_n-t_0) < T_total):
            i = x_n
            # q i _ i+1
...
while iteration < 12000 or abs(pr - Beta)/Beta > 0.1:
    # simulate K days of X_n obtain T_H/T, starting from t_0 = 0 and x0 = x_n
